            ...
            <Card className="p-4 rounded-4">
              ...
              <Form onSubmit={handleSignup}>
                ...
                <Form.Group className="mb-3">
                  ...
                  {password.length > 0 && password.length < 8 && <Form.Text style={{ color: "red" }}>Password must be at least 8 characters</Form.Text>}
                </Form.Group>
                <Form.Group className="mb-3">
                  <Form.Label>Confirm Password</Form.Label>
                  <Form.Control type="password" placeholder="Confirm Password" value={confirm} onChange={e => setConfirm(e.target.value)} required />
                  {confirm.length > 0 && confirm !== password && <Form.Text style={{ color: "red" }}>Passwords do not match</Form.Text>}
                </Form.Group>
                ...
                <NavLink to="/login" className="w-100 d-block text-center" style={{ border: "1px solid #c7c7c7ff", backgroundColor: "white", color: "#000", padding: "8px", borderRadius: "5px", textDecoration: "none" }}>
                  Sign in instead
                </NavLink>
              </Form>
            </Card>
