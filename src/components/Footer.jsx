...
function Footer() {
    return (
        <footer className="text-dark pt-4 mt-5 shadow-sm" style={{ borderTop: "1px solid #dbd8d8ff" }}>
            <Container>
                <Row className="gy-4">
                    {/* Column 1 */}
                    <Col lg={3} md={6} sm={12}>
                    ...
                    <Col lg={3} md={6} sm={12}>
                        ...
                        <ul className="list-unstyled">
                            <li><a href="#home" className="text-decoration-none text-dark">Contact Us</a></li>
                            <li><a href="#shop" className="text-decoration-none text-dark">Shop</a></li>
                            <li><a href="#about" className="text-decoration-none text-dark">About</a></li>
                            <li><a href="#contact" className="text-decoration-none text-dark">Contact</a></li>
                        </ul>
                ...
                <div className="d-flex flex-column flex-md-row justify-content-between align-items-center" style={{ borderTop: "1px solid #adacacff", padding: "10px" }}>
                    <p className="mb-0">&copy; {new Date().getFullYear()} E-Commerce Store. All rights reserved.</p>
                    <div className="d-flex gap-3 mt-2 mt-md-0" style={{}}>
